...
-- Records of employee
-- ----------------------------
INSERT INTO `employee` VALUES (1, '123', '123@qq.com', '北京市海淀区', '1', '123', 'Oh...Yeah！！！', '/files/1725415836307_3.jpg', '0', b'1', '超级系统拥有者', '哇哈哈', '2024-09-04 13:39:01', 999, 10, '411111199905089999', NULL);
...
CREATE TABLE `goods`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin ROW_FORMAT = COMPACT;
...
CREATE TABLE `t_role_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 209 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin ROW_FORMAT = COMPACT;
