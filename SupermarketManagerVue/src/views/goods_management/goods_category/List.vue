<template>
    <div>
        <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>分类管理</el-breadcrumb-item> </el-breadcrumb><br />
        <el-row>
        ...
        <div class="table">
            <el-table :data="tableData" style="width: 100%" size="medium">
                ...
                <el-table-column prop="info" label-width="100px" :show-overflow-tooltip="true" label="描述">
                </el-table-column>
        ...
        <el-dialog title="分类信息修改" :visible.sync="dialogVisible" width="50%">
            <el-form :model="editForm" :rules="rules" ref="editForm" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item>
                    <el-button type="primary" @click="submitEditForm('editForm')" style="font-size: 18px">
                        <i class="iconfont icon-r-yes" style="font-size: 18px"></i>
                        提交</el-button>
                    <el-button @click="resetEditForm('editForm')" style="font-size: 18px">
...
export default {
    ...
    methods: {
        ...
        resetEditForm(formName) {
            ...
            this.editForm = { ...this.oldEditForm };
