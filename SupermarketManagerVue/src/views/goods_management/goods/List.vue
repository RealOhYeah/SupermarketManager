...
<template>
    <div>
        <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>商品信息</el-breadcrumb-item> </el-breadcrumb><br />
        <el-row>
            ...
            <el-col :span="6">
                <el-select v-model="searchForm.categoryId" placeholder="商品分类" filterable @change="$forceUpdate()"
                    clearable>
                    <el-option v-for="item in options_category" :key="item.id" :label="item.name" :value="item.id">
                    </el-option>
                </el-select>
            </el-col>
        </el-row>
        ...
        <el-row>
            ...
            <el-col :span="18">
                <span>时间：</span>
                <el-date-picker v-model="searchForm.operateStartTime" type="date" placeholder="起始时间">
                </el-date-picker>
                -
                <el-date-picker v-model="searchForm.operateEndTime" type="date" placeholder="结束时间">
                </el-date-picker>
            </el-col>
        </el-row>
        <br />
                ...
                <el-table-column width="360" fixed="right" label="操作">
                    <template v-slot="scope">
                        ...
                        <el-button type="danger" @click="returnBtn(scope.row.id)" style="font-size: 18px">
                            <i class="iconfont icon-r-left" style="font-size: 18px">
                            </i>
                            退还</el-button>
                        <el-button v-if="scope.row.state == '0'" type="warning" @click="
                                upOrdown(
                                    scope.row.id,
                                    scope.row.state,
                            ...
                            <i class="iconfont icon-r-bottom" style="font-size: 18px">
                            </i>
                            下架
                        </el-button>
                        <el-button v-if="scope.row.state == '1'" type="warning"
                            @click="upOrdown(scope.row.id, scope.row.state)" style="font-size: 18px">
                            <i class="iconfont icon-r-top" style="font-size: 18px">
                            </i>
                            上架
                        </el-button>
                    </template>
        ...
        <el-dialog title="创建商品" :visible.sync="newVisable" @close="dialog_imgClose" width="50%">
            <el-form :model="newForm" :rules="rules" ref="newForm" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item>
                    <span>分类：</span>
                    <el-select v-model="newForm.categoryId" placeholder="请选择分类" filterable @change="$forceUpdate()"
                        clearable>
                        <el-option v-for="item in options_category" :key="item.id" :label="item.name" :value="item.id">
                        </el-option>
                    </el-select>
        ...
        <el-dialog title="修改商品信息" :visible.sync="dialogVisible" @close="dialog_imgClose" width="450px">
            <el-form :model="editForm" :rules="rules" ref="editForm" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item label="销售价格：">
                    <el-input v-model="editForm.sellPrice" placeholder="如：9.9"></el-input>
                </el-form-item>
                <el-form-item label="描述：">
                    <el-input type="textarea" placeholder="如：农夫山泉是矿泉水" v-model="editForm.info"></el-input>
                </el-form-item>
                <el-form-item style="width: 40%" label="分类：">
                    <el-select v-model="editForm.categoryId" placeholder="请选择分类" filterable @change="$forceUpdate()"
                        clearable>
                        <el-option v-for="item in options_category" :key="item.id" :label="item.name" :value="item.id">
                        </el-option>
                    </el-select>
                ...
                <el-form-item>
                    ...
                    <el-button @click="resetEditForm('editForm')">关闭</el-button>
                </el-form-item>
            </el-form>
        </el-dialog>
        <!--退还表单-->
        <el-dialog title="退还商品入库信息" :visible.sync="returnVisible" width="60%">
            <el-form :model="returnForm" :rules="rules" ref="returnForm" label-width="100px" class="demo-ruleForm">
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="商品名：">
                            <el-input readonly v-model="returnForm.goodsName" placeholder="如：农夫山泉"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                    ...
                    <el-col :span="12">
                        <el-form-item label="数量：" prop="goodsNum">
                            <el-input type="number" @change="
                                ...
                                " min="1" :max="goodsNum_max" v-model="returnForm.goodsNum"
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="描述：">
                            <el-input type="textarea" placeholder="如：该商品正执行下架操作" v-model="returnForm.info"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <i class="returnMessage">
                ...
                <el-form-item style="width: 80%">
                    <el-button type="primary" @click="submitReturnForm('returnForm')" style="font-size: 18px">
                        <i class="iconfont icon-r-yes" style="font-size: 18px">
                        </i> 确定</el-button>
                    <el-button @click="resetReturnForm('returnForm')" style="font-size: 18px">关闭</el-button>
                </el-form-item>
            </el-form>
        </el-dialog>
    </div>
